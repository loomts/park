...
func NewTouristCarProvinceModel(conn sqlx.SqlConn, c cache.CacheConf) TouristCarProvinceModel {
	return &customTouristCarProvinceModel{
		defaultTouristCarProvinceModel: newTouristCarProvinceModel(conn, c),
	}
}
