<template>
  ...
  <el-tabs :tab-position="tabPosition" style="height: 380px; stretch:true;">
    <el-tab-pane label="地下停车场1"><div id="main21" style="width: 400px;height:300px;"></div></el-tab-pane>
    <el-tab-pane label="地下停车场2"><div id="main22" style="width: 400px;height:300px;"></div></el-tab-pane>
    <el-tab-pane label="地下停车场3"><div id="main23" style="width: 400px;height:300px;"></div></el-tab-pane>
  </el-tabs>
   </div>
</template>
