...
.boxall li,.boxall li{ width:50%; text-align: center; position: relative; z-index: 100;}
.boxall:before,
.boxall:after{ position:absolute; width: .3rem; height: .1rem; content: ""; }
.boxall:before {position: absolute;
  top: 0px;
  left: 0px;
  width: 10px;
  height: 10px;
  ...
  content: ""; }
.boxall:after{ position: absolute;
  top: 0px;
  right: 0px;
  width: 10px;
  height: 10px;
  ...
  border-top: 2px solid #02a6b5;
  content: ""; }
.foot1:before{position: absolute;
  bottom: 0px;
  right: 0px;
  width: 10px;
  height: 10px;
...
.boxall li:first-child:before{ position:absolute; content: ""; height:50%; width: 1px; 
background: rgba(255,255,255,.2); 
right: 0; top: 25%;}

.boxall{  border: 1px solid rgba(25,186,139,.70); position: relative;}
.boxall li{ font-size: 40px; color: #ffeb7b; padding: .05rem 0;  font-family:electronicFont; font-weight: bold;}
.boxall li{ font-size: 20px; color:rgba(255,255,255,.7); padding-top: .1rem;}


//2
.boxall2 li,.boxall2 li{ width:50%; text-align: center; position: relative; z-index: 100;}
.boxall2:before,
.boxall2:after{ position:absolute; width: .3rem; height: .1rem; content: ""; }
.boxall2:before {position: absolute;
  top: 0px;
  left: 0px;
  width: 10px;
  height: 10px;
  ...
  border-top: 2px solid #02a6b5;
  content: ""; }
.boxall2:after{ position: absolute;
  top: 0px;
  right: 0px;
  width: 10px;
  height: 10px;
  ...
  border-top: 2px solid #02a6b5;
  content: ""; }
.foot2:before{position: absolute;
  bottom: 0px;
  right: 0px;
  width: 10px;
  height: 10px;
...
.boxall2 li:first-child:before{ position:absolute; content: ""; height:50%; width: 1px; 
background: rgba(255,255,255,.2); 
right: 0; top: 25%;}

.boxall2{  border: 1px solid rgba(25,186,139,.70); position: relative;}
.boxall2 li{ font-size: 40px; color: #ffeb7b; padding: .05rem 0;  font-family:electronicFont; font-weight: bold;}
.boxall2 li{ font-size: 20px; color:rgba(255,255,255,.7); padding-top: .1rem;}


// 4
.boxall4 li,.boxall4 li{ width:50%; text-align: center; position: relative; z-index: 100;}
.boxall4:before,
.boxall4:after{ position:absolute; width: .3rem; height: .1rem; content: ""; }
.boxall4:before {position: absolute;
  top: 0px;
  left: 0px;
  width: 10px;
  height: 10px;
  ...
  border-top: 2px solid #02a6b5;
  content: ""; }
.boxall4:after{ position: absolute;
  top: 0px;
  right: 0px;
  width: 10px;
  height: 10px;
  ...
  border-top: 2px solid #02a6b5;
  content: ""; }
.foot4:before{position: absolute;
  bottom: 0px;
  right: 0px;
  width: 10px;
  height: 10px;
...
.boxall4 li:first-child:before{ position:absolute; content: ""; height:50%; width: 1px; 
background: rgba(255,255,255,.2); 
right: 0; top: 25%;}

.boxall4{  border: 1px solid rgba(25,186,139,.70); position: relative;}
.boxall4 li{ font-size: 40px; color: #ffeb7b; padding: .05rem 0;  font-family:electronicFont; font-weight: bold;}
.boxall4 li{ font-size: 20px; color:rgba(255,255,255,.7); padding-top: .1rem;}


// 5
.boxall5 li,.boxall5 li{ width:50%; text-align: center; position: relative; z-index: 100;}
.boxall5:before,
.boxall5:after{ position:absolute; width: .3rem; height: .1rem; content: ""; }
.boxall5:before {position: absolute;
  top: 0px;
  left: 0px;
  width: 10px;
  height: 10px;
  ...
  border-top: 2px solid #02a6b5;
  content: ""; }
.boxall5:after{ position: absolute;
  top: 0px;
  right: 0px;
  width: 10px;
  height: 10px;
  ...
  border-top: 2px solid #02a6b5;
  content: ""; }
.foot5:before{position: absolute;
  bottom: 0px;
  right: 0px;
  width: 10px;
  height: 10px;
...
.boxall5 li:first-child:before{ position:absolute; content: ""; height:50%; width: 1px; 
background: rgba(255,255,255,.2); 
right: 0; top: 25%;}

.boxall5{  border: 1px solid rgba(25,186,139,.70); position: relative;}
.boxall5 li{ font-size: 40px; color: #ffeb7b; padding: .05rem 0;  font-family:electronicFont; font-weight: bold;}
.boxall5 li{ font-size: 20px; color:rgba(255,255,255,.7); padding-top: .1rem;}
...
.cot  .el-table, .el-table__expanded-cell {
    background-color: transparent;
}
...
.cot  .el-table--enable-row-transition .el-table__body td, .el-table .cell{
   background-color: transparent;
}
