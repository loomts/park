  ...
  <div id="whole">
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="认证旅客" name="first">
        <el-tag type="success" effect="light" class="disinfect">
          <span>认 证 旅 客</span>
        </el-tag>
        <center style="margin-top: 20px; margin-bottom: 100px">
          <el-container class="cot" style="width: 1200px">
            <el-main>
              <el-table
                :data="tableData_1"
                :header-cell-style="{ background: '#ecf8f3', color: '#ffffff' }"
      ...
      <el-tab-pane label="未认证旅客" name="second">
        <el-tag type="warning" effect="light" class="disinfect">
          <span>未 认 证 旅 客</span>
        </el-tag>
        <center style="margin-top: 20px; margin-bottom: 100px">
          <el-container class="cot" style="width: 1000px">
            <el-main>
              <el-table
                :data="tableData_2"
                :header-cell-style="{ background: '#fff6e8', color: '#ffffff' }"
                style="font-size: 30px"
              >
                <el-table-column
                  prop="id"
